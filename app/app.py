...
h1 { color: #582f0e; text-align: center; }
.stButton>button {
    width: 100%;
...
st.title("🌳 Random Forest Regressor - California Housing")
...
ax1.scatter(y_test[:200], y_pred[:200], alpha=0.5, color="#582f0e")
...
sns.histplot(y, kde=True, color="#582f0e", ax=ax3)
...
sns.heatmap(df.corr(), annot=True, cmap="YlOrBr", fmt=".2f", ax=ax4)
...
st.markdown("---")
st.markdown("Developed using Streamlit and Random Forest Regressor")